                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarTwo">
                            <ul class="navbar-nav m-auto">
                                <li class="nav-item active"><a class="page-scroll" href="#home">Don du sang</a></li>
                                <li class="nav-item"><a class="page-scroll" href="#services">Don de moëlle</a></li>
                                <li class="nav-item"><a class="page-scroll" href="#portfolio">Evenements</a></li>
                                <li class="nav-item"><a class="page-scroll" href="#pricing">Inscription</a></li>
                                <li class="nav-item"><a class="page-scroll" href="#about">Contact</a></li>
                            </ul>
                        </div>
